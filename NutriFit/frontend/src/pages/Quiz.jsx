...
function Quiz() {
  ...
  const gerarPlano = async () => {
    ...
    else if (formData.objetivo === 'ganho_de_massa_magra' || formData.objetivo === 'ganho_de_peso') calorias = 2500;
      ...
      <div className="quiz-container">
          ...
          <div className="quiz-card">
            ...
            <div className="quiz-options">
              {[
                ...
                { label: 'Perder Peso', value: 'perda_de_peso' },
        ...
        {etapa === 6 && resumo && (
          <div className="quiz-card resultado">
            ...
            <p><strong>IMC:</strong> {resumo.imc.toFixed(2)}</p>
            <p><strong>Objetivo:</strong> {resumo.objetivo.replace(/_/g, ' ')}</p>
